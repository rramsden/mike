...
#define JS_I_THIS info.This()
#define JS_I_HOLDER info.Holder()
#define JS_UNWRAP(t) t* self = Unwrap<t>(JS_THIS)
#define JS_UNWRAP_HOLDER(t) t* self = Unwrap<t>(JS_HOLDER)
#define JS_UNWRAP_CALLEE(t) t* self = Unwrap<t>(JS_CALLEE)
#define JS_I_UNWRAP(t) t* self = Unwrap<t>(JS_I_THIS)
#define JS_I_UNWRAP_HOLDER(t) t* self = Unwrap<t>(JS_I_HOLDER)
#define JS_UNWRAP_WINDOW Frame* window = Unwrap<Frame>(JS_GLOBAL)
